...
####################################################################################
create_clock -period 2.000 -name CC_PL_CLK_clk -waveform {0.000 1.000} [get_ports pl_clk_p]
...
set_input_delay -clock [get_clocks CC_PL_CLK_clk] -min -add_delay 2.000 [get_ports sysref_in_p]
set_input_delay -clock [get_clocks CC_PL_CLK_clk] -max -add_delay 2.031 [get_ports sysref_in_p]
...
set_property IOSTANDARD LVDS_25 [get_ports sysref_in_p]
set_property IOSTANDARD LVDS_25 [get_ports sysref_in_n]
set_property PACKAGE_PIN B10 [get_ports sysref_in_p]
