...
set_property LOC BUFGCE_HDIO_X0Y2 [get_cells -hierarchical -filter {NAME =~ "*rfsoc_clk_ss/util_ds_buf_1/U0/USE_BUFGCE.GEN_BUFGCE[0].BUFGCE_U"}]
set_property LOC MMCM_X0Y3 [get_cells -hierarchical -filter {NAME =~ "*rfsoc_clk_ss/clk_wiz_0/inst/mmcme4_adv_inst"}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets -hierarchical -filter {NAME =~ "*rfsoc_clk_ss/util_ds_buf_1/U0/BUFGCE_O[0]"}]
# Lock PL SYSREF capture FF
set_property BEL BFF2 [get_cells -hierarchical -filter {NAME =~ "*rfsoc_clk_ss/pl_sysref_0/inst/pl_sysref_r_reg"}]
set_property LOC SLICE_X107Y216 [get_cells -hierarchical -filter {NAME =~ "*rfsoc_clk_ss/pl_sysref_0/inst/pl_sysref_r_reg"}]
####################################################################################
