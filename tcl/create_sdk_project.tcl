...
#---------------------------
app create -name a53_fsbl -template {Zynq MP FSBL} -hw ${prj_dir}/${top_name}.xsa -proc psu_cortexa53_0  -os standalone
#---------------------------
# create pmufw from template
#---------------------------
app create -name pmu_fw -template {ZynqMP PMU Firmware} -hw ${prj_dir}/${top_name}.xsa -proc psu_pmu_0 -os standalone
#-------------------
# create application 
#-------------------
