...
void dacReset(u32 *cmdVals)
{
	...
	{
		xil_printf("DAC Tile%d is not available.\n\r", Tile_Id);
	}
	xil_printf("###############################################\r\n\n");
...
void adcReset(u32 *cmdVals)
{
	...
	{
		xil_printf("ADC Tile%d is not available.\n\r", Tile_Id);
	}
	xil_printf("###############################################\r\n\n");
...
//HB 	XRFdc_MultiConverter_Init(&ADC_Sync_Config, 0, 0);
//HB 	XRFdc_MultiConverter_Init(&DAC_Sync_Config, 0, 0);
